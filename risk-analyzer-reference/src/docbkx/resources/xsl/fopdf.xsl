...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- <xsl:template match="xref"> <fo:basic-link internal-destination="{@linkend}" 
		xsl:use-attribute-sets="xref.properties" text-decoration="underline" color="blue"> 
		<xsl:apply-templates/> </fo:basic-link> </xsl:template> -->
